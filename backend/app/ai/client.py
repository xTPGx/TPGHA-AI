    ...
    def _general_via_openai(
        ...
        *,
        ...
        system = (
            ...
            "For voice/chat, be human and direct: keep replies to one to three concise "
            "sentences unless the user asks for detail. Do not end every response with a "
            "generic question. Do not say 'How can I assist you today?' unless the user asks "
            "for that exact phrasing. Stay in English unless the user clearly asks for another "
